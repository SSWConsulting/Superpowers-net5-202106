...
export class TodoItemsClient {
    ...
    postTodoItem(todoItem: TodoItem): Observable<number> {
...
export class TodoListsClient {
    ...
    getTodoLists(): Observable<TodoListVm> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<TodoListVm>><any>_observableThrow(e);
                }
            } else
                return <Observable<TodoListVm>><any>_observableThrow(response_);
        }));
    }

    protected processGetTodoLists(response: HttpResponseBase): Observable<TodoListVm> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = TodoListVm.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<TodoListVm>(<any>null);
    }
    ...
    protected processGetTodoList(response: HttpResponseBase): Observable<TodoList> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class TodoListVm implements ITodoListVm {
    priorityLevels?: LookupDto[] | undefined;
    lists?: TodoListDto[] | undefined;

    constructor(data?: ITodoListVm) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): TodoListVm {
        data = typeof data === 'object' ? data : {};
        let result = new TodoListVm();
        result.init(data);
        return result;
    }
